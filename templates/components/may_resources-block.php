<section class="download-block resources-block background-lightgrey" <?php if( get_sub_field('id')){?>id="<?php the_sub_field('id'); ?>"<?php } ?>>
    <div class="container">
        <?php if(get_sub_field( 'title' )){ ?>
            <span class="download-block-title"><?php the_sub_field( 'title' ); ?></span>
        <?php } ?>
		<?php
		$count = 0;
	            ...
	            <?php $counter = 0; ?>
					<?php while ( have_rows( 'resource' ) ) : the_row(); ?>
	                    <div class="column <?php echo $counter; ?>">
                            ...
                            <?php } ?>
	                        <?php if ( get_sub_field( 'resource_type' ) == 'video') { ?>
	                            <a class="popup-vimeo resources-video-popup" href="https://vimeo.com/<?php the_sub_field( 'vimeo_code' ); ?>">
	                        ...
	                        <?php }?>
	                            <?php if(get_sub_field( 'title' )){ ?>
	                                ...
	                                <span class="listing-title"><?php the_sub_field( 'title' ); ?></span>
	                            <?php } ?>
    	                                        ...
    	                                        <span class="downloads">
    	                                            ...
    	                                            <?php if ( have_rows( 'download' ) ) : ?>
    	                                                ...
    	                                                <?php while ( have_rows( 'download' ) ) : the_row(); ?>
    	                                                    <span class="download-button-container<?php if($buttonCounter == 1){ ?> active<?php }?> <?php the_sub_field( 'download_file_type' ); ?>" id="<?php the_sub_field( 'download_file_type' ); ?>"><?php the_sub_field( 'download' ); ?></span>
                                                            <?php $buttonCounter++; ?>
    	                                                <?php endwhile; ?>
    	                                            <?php else : ?>
    	                                                <?php // no rows found ?>
                                                    ...
                                                    <?php if ( have_rows( 'download' ) ) : ?>
                                                        <span class="download-dropdown-container">
                                                            <ul class="download-switch-container<?php if ($count == 1){ ?> no-dropdown<?php } else { ?> dropdown-select<?php } ?>">
                                                                <?php $switchCounter=1; ?>
            	                                                <?php while ( have_rows( 'download' ) ) : the_row(); ?>
            	                                                    <li class="download-switch <?php if($switchCounter == 1){ ?> active<?php }?>" value="<?php the_sub_field( 'download_file_type' ); ?>">
                                                                        <span class="download-switch-span"><?php the_sub_field( 'download_file_type' ); ?></span>
                                                                        <a class="download-switcher" href="#<?php the_sub_field( 'download_file_type' ); ?>"><?php the_sub_field( 'download_file_type' ); ?></a>
                                                                    </li>
                                                                    <?php $switchCounter++; ?>
            	                                                <?php endwhile; ?>
                                                            </ul>
