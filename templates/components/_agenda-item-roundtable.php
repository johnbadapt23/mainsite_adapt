                                                    ...
                                                    <div class="column white-bg image-column">
                                                        ...
                                                        <h3 class="title">
                                                            ...
                                                            <?php if ( get_field('linkedin')) { ?>
                                                                <a class="linkedin-link" href="<?php echo esc_url( get_field('linkedin') ); ?>" target="_blank" rel="noopener noreferrer"><img loading="lazy" src="<?php echo get_template_directory_uri(); ?>/assets/images/round-linkedin.svg" alt="LinkedIn" width="20"/></a>
                                                            <?php } ?>
                                                        </h3>
                            ...
                            <span class="speakers-title-container">
                                <?php while ( have_rows( 'speakers' ) ) : the_row(); ?>
                                    ...
                                    <?php if ( $speaker ): ?>
                                        <?php $counterName=1; ?>
                                        <?php foreach ( $speaker as $post ):  ?>
                                            <a class="speaker-popup-text" href="#<?php echo $agendaGallery; ?>speakerPopup-<?php echo $counterName;?>-<?php echo $roundtableCounter; ?>">
                                                <span class="speaker">
                                                    <?php setup_postdata ( $post ); ?>
