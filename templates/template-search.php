                        ...
                        <form action="/edge-events/" name="insightsFilter" class="insightsFilter" method="get">
                            ...
                            <span class="types">
                                ...
                                <?php foreach($terms as $term) { ?>
                                    ...
                                    <span class="checkboxButton">
                                        <label>
                                          <input type="checkbox" name="types[]" <?php if($filterType == '') { } else { if (in_array( $term -> slug, $filterType )) { ?> checked <?php }}?> value="<?php echo $term -> slug; ?>"><span class="checkbox-text"><?php echo adapt_acf_image( $image, 'full', array( 'alt' => '' ) ); ?><?php echo $term -> name; ?></span>
                                        </label>
                                    </span>
                                <?php } ?>
                            </span>
