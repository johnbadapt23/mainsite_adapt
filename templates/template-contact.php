...
<main class="page flexible contact background-black" id="main">
    <section class="contact-module">
        <div class="container">
            <div class="contact-innner">
                <div class="title-details-column column">
                    <h1 class="white-text"><?php echo get_field( 'contact_form_title' ); ?></h1>
                    <span class="contact-image-container">
                ...
                <div class="sub-title-form-column column">
                    <span class="white-text form-sub-title"><?php echo get_field( 'contact_form_sub_title' ); ?></span>
