    			...
    			<h2 class="form-module-title"><?php echo get_sub_field( 'title' ); ?></h2>
                 ...
                 <span class="bottom-container">
                     <?php if(get_sub_field('form_type') == 'hubspot-form'){ ?> 
                        <span class="form-popup-button-container"><a class="formPopupHubspot stdBtn std-button" href="#parterFormPopup"><?php echo get_sub_field( 'hubspot_form_button_text' ); ?></a></span>
