<section class="keynote-slider-module">
	<div class="container">
		...
		<div class="progress-container">
            ...
            <div class="keynote-progress" role="progressbar" aria-valuemin="0" aria-valuemax="100" aria-valuenow="<?php echo $slidePercent;?>" aria-label="Slide progress" style="background-size:<?php echo $slidePercent;?>%"></div>
		</div>
	</div>
</section>
