...
<section class="events-listing-module background-black" <?php if (get_sub_field( 'id' )) { ?>id="<?php echo get_sub_field( 'id' ); ?>"<?php } ?>>
            ...
            <span class="year-button-container" id="yearButtons">
                <span class="year-button-sticky">
                    ...
                    <span class="back-top-mobile-sticky">
                        <a class="back-to-top-sticky" href="#"></a>
    ...
    <div class="events-listing partners-events-listing">
        <?php
        $today = date('Ymd');
        $args = array(
            'post_type' => 'event',
        ...
        if ($posts->have_posts()): 
            $seen_years = array(); // Array to keep track of seen years
            while ($posts->have_posts()): $posts->the_post();
                ...
                <?php if (get_field('event_link')): ?> 
                    <a href="<?php echo get_field('event_link'); ?>" target="_blank">
                <?php endif; ?>                    
                    <span class="item event-item background-black <?php echo $year; ?> <?php echo $firstClass; ?>" data-date="<?php echo $year; ?>" <?php echo $id_attribute; ?>>
                        <span class="container">
                            ...
                            <span class="content-delegate-container">
                                <span class="item-content column">
                                    <span class="content-inner">
                                        <span class="title text-white labelXXLarge"><?php the_title(); ?></span>
                                        <p class="location labelMedium text-medium-grey"><?php echo get_field('location'); ?> / <?php echo $date->format('j M'); ?> <?php echo $year; ?></p>
                                        <?php if (get_field('partners_listing_description')): ?>
                                            <p class="excerpt text-white"><?php echo get_field('partners_listing_description'); ?></p>
                                        <?php else: ?>
                                            <p class="excerpt text-white"><?php echo get_field('listing_description'); ?></p>
                                        <?php endif; ?>
                                    </span>
                                </span>
                                <?php if (have_rows('delegate_tags')): ?>
                                    <span class="delegate-tags column">
                                        <span class="labelMedium text-medium-grey">Delegate Breakdown</span>
                                        <span class="tags-container">
                                            <?php while (have_rows('delegate_tags')): the_row(); ?>
                                                <span class="tag delegate-tag"><?php echo get_sub_field('delegate_tag'); ?></span>
                                            <?php endwhile; ?>
                                        </span>
                                    </span>
                                <?php else: ?>
