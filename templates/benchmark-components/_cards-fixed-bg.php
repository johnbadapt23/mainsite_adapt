<section class="cards-module background-fixed gtm-cards-module background-black benchmark-card-module" <?php if(get_sub_field('id')){ ?> id="<?php echo get_sub_field('id');?>"<?php } ?>>
	<div class="container">
		...
		<div class="background-card-container">
			...
			?>
			<div class="background-container desktop-show" style="background-image:url(<?php echo $background_image['url']; ?>)">
			</div>
			<div class="background-container mobile-show" style="background-image:url(<?php echo $mobile_background_image['url']; ?>)">
			</div>
			<div class="card-container desktop">
				<?php if ( have_rows( 'cards' ) ) : ?>
					<?php while ( have_rows( 'cards' ) ) : the_row(); ?>
						<div class="card<?php if ( get_sub_field( 'standard_card' ) != 1 ) { ?> no-overlay<?php } ?>">
