                ...
                <span class="apply-container bottom-position">
                    ...
                    <span class="share-job-container desktop">
                        <span class="copy-link">
                            ...
                            <a onclick="copyJobLink()">
                                <span class="image-icon-container">
                                    <img class="standard" src="<?php echo get_template_directory_uri(); ?>/assets/images/copy-link.svg" width="32px"/>
                                    <img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/copy-link-hover.svg" width="32px"/>
                                </span>
                        ...
                        <span class="email-link">
                            <a class="email-button" href="mailto:?&subject=<?php the_title(); ?>&body=<?php echo the_permalink(); ?>" target="_blank">
                                <span class="image-icon-container">
                                    <img class="standard" src="<?php echo get_template_directory_uri(); ?>/assets/images/job-email.svg" width="32px"/>
                                    <img class="hover" src="<?php echo get_template_directory_uri(); ?>/assets/images/email-red-hover.svg" width="32px"/>
                                </span>
                    ...
                    <span class="back-top-link">
                        <a class="back-to-top" href="#">
                            <img src="<?php echo get_template_directory_uri(); ?>/assets/images/job-back-top.svg" width="32px"/>
