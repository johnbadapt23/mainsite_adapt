<?php
/**
 * Template Name: Comparison Template
 */
...
<main class="page flexible" id="main">  
    <?php if ( have_rows( 'content' ) ): ?>
        <?php while ( have_rows( 'content' ) ) : the_row(); ?>
            ...
            <?php elseif ( get_row_layout() == 'left_text_with_links' ) : ?>  
                <?php get_template_part( 'templates/customer-events-components/_left-text-links' ); ?> 
            ...
            <?php elseif ( get_row_layout() == 'sticky_heading_with_cards' ) : ?> 
                <?php get_template_part( 'templates/customer-events-components/_sticky-heading-cards' ); ?>  
