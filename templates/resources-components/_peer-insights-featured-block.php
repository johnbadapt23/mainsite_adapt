    ...
    <div class="container">
        <div class="title-container">
            <div class="introduction-column two-thirds">
                <?php
                $term = get_term_by('slug', 'peer-insights', 'resource-type');
                ...
                ?>
                <?php if (get_sub_field( 'peer-insights' )) {?>
                ...
                <?php } else { ?>
                    ...
                    <h2 class="taxonomy-title text-white"><?php echo $term ? $term->name : ''; ?></h2>
                    <p class="taxonomy-description text-white"><?php echo $term ? $term->description : ''; ?></p>
                <?php } ?>
            </div>
        ...
        <div class="post-container">
            <div class="column two-thirds slide-column">
                <div class="peer-featured-slider">
