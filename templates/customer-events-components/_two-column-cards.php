            ...
            <div class="button-container" data-aos="fade-up" data-aos-anchor-placement="center-bottom" data-aos-duration="800">
				<?php while ( have_rows( 'button' ) ) : the_row(); ?>
                    ...
                    <?php } else if( get_sub_field( 'button_type' ) == 'hubspot-form') { ?> 
                        <a class="formPopupHubspot std-button red-button button-with-arrow white-arrow-button" href="#twoColumnCards"><?php echo get_sub_field( 'button_text' ); ?></a>
                        <div style="display: none;">         
                            <div class="preview-cta-form login-form-container" id="twoColumnCards">
