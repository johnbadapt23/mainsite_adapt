                                            ...
                                            <div class="bio-content-wrapper">
                                                ...
                                                <span class="bio-top">
                                                    ...
                                                    <span class="text">
                                                        ...
                                                        <a class="linkedin" href="<?php echo esc_url( get_field('linked_in_url') ); ?>"><img loading="lazy" class="linkedin-icon" src="<?php echo get_template_directory_uri(); ?>/assets/images/linkedin-new.svg" alt="LinkedIn" width="28" /></a>
                                                    </span>
                                                </span>
