<section class="topic-industry-switcher background-white" <?php if(get_sub_field('id')){ ?> id="<?php echo get_sub_field('id'); ?>"<?php } ?>>
    <div class="container">
        ...
        <div class="bottom-container">
            ...
            <div class="industries-container">
                ...
                <div class="image-outer">
                    ...
                    <?php if ( $mobile_image ) { ?>
                        <img loading="lazy" class="mobile desktop-hide" src="<?php echo $mobile_image['url']; ?>" alt="<?php echo $mobile_image['alt']; ?>" />
                    <?php } ?>
                </div>
            </div>
        </div>
