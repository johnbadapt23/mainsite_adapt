                        ...
                        <span class="link-container">                        
                            <?php while ( have_rows( 'link' ) ) : the_row(); ?>
                                ...
                                <?php } else if( get_sub_field( 'link_type' ) =='hubspot-form') { ?> 
                                    <a class="formPopupHubspot std-button red-outline-button button-with-arrow red-arrow-button" href="#speakerHubspot"><?php echo get_sub_field( 'link_text' ); ?></a>
								    <div style="display: none;">         
									<div class="preview-cta-form login-form-container mfp-hide" id="speakerHubspot">
										<div class="form-container">
											<?php echo get_sub_field('form_code'); ?>
										</div>
									</div>
								</div>
                                <?php } ?>
