    ...
    <?php if ( have_rows( 'content' ) ): ?>
        <?php while ( have_rows( 'content' ) ) : the_row(); ?>
            ...
            <?php elseif ( get_row_layout() == 'left_text_with_links_image' ) : ?>  
                <?php get_template_part( 'templates/customer-events-components/_left-text-links-image' ); ?> 
            <?php elseif ( get_row_layout() == 'advisors_carousel' ) : ?>   
                <?php get_template_part( 'templates/customer-events-components/_advisors-carousel' ); ?> 
            <?php elseif ( get_row_layout() == 'sticky_heading_with_cards' ) : ?> 
                <?php get_template_part( 'templates/customer-events-components/_sticky-heading-cards-evr' ); ?>  
            <?php elseif ( get_row_layout() == 'sticky_slider_cards' ) : ?>  
                <?php get_template_part( 'templates/customer-events-components/_sticky-slider-cards' ); ?>                    
            <?php elseif ( get_row_layout() == 'two_column_image_text_switcher' ) : ?>
                <?php get_template_part( 'templates/customer-events-components/_two-column-switcher' ); ?> 
            <?php elseif ( get_row_layout() == 'two_column_steps' ) : ?>
                <?php get_template_part( 'templates/customer-events-components/_two-column-steps' ); ?> 
            ...
            <?php elseif ( get_row_layout() == 'comparison_module' ) : ?>  
                <?php get_template_part( 'templates/customer-events-components/_comparison-module' ); ?>   
