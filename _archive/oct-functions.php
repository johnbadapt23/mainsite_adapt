            ...
            <div class="one-third speaker-item one-third column" data-filter="<?php echo esc_attr($filter_slugs); ?>">
                <a class="slide-out-bio" href="#<?php echo $post_slug; ?>" id="<?php echo $post_slug; ?>">
                    <span class="image-container">
                        ...
                        <span class="text-container">
                            ...
                            <span class="learn-more red-text">Learn More</span>
                        </span>
                    </span>
                    <span class="text-container desktop-hide">
                        ...
                        <span class="learn-more red-text external-link">Learn More</span>
                    </span>
                </a>
                <div id="<?php echo $post_slug; ?>" class="full-bio">
                    ...
                    <span class="bio-top">
                        ...
                        <span class="text">
                            <h2><?php the_title(); ?></h2>
                            <h3><?php echo esc_html(get_field('speaker_description')); ?></h3>
                            <a class="linkedin" href="<?php echo esc_url(get_field('linked_in_url')); ?>"><img class="linkedin-icon" src="<?php echo esc_url(get_template_directory_uri()); ?>/assets/images/linkedin-new.svg" width="28" /></a>
                        </span>
                    </span>
                    <span class="bio-bottom">
                        <?php echo wp_kses_post(get_field('speaker_details')); ?>
                        <span class="speaker-button-container">
                            <span class="std-button form-popup-button-container red-button"><?php the_field( 'speaker_form_button', 'options' ); ?></span>
                        </span>
                    </span>
                </div>
