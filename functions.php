...
// Critical-CSS defer for the main bundle (S112/S114 plan, not yet active --
// see SESSION-HANDOFF.md S110-S114). Mirrors the same preload+onload
...
// assets/critical/ does not exist on the server yet -- a scheduled GitHub
// Actions workflow (.github/workflows/critical-css.yml, S114) generates
// and uploads it directly, with no WordPress-side trigger code at all --
// so adapt_get_critical_css_path() always returns false right now, this
